...
export class DragdropComponent implements OnInit {
  ...
  constructor(private router : Router,private schedullingSoltService :SlotService,private schedullingService :AllocateService,private dragulaService: DragulaService) { }
  ...
  ////////////////////////////////////////////////////////////
   ...
   //////////////////////////////////////////////////////////////////
   SaveAllSchedling(){
    this.schedullingService.Combine(this.scheduls).subscribe(
      schedulling =>{
  ...
  ////////////////////////////////////////////////////////////////
  onSaveSchedling(){
    this.schedullingService.saveSchedullings(this.schedulling).subscribe(
      schedulling =>{
